      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-10 text-center">
        ...
        <div className="bg-gray-50 rounded-xl p-5 text-left mb-6 space-y-2.5">
          ...
          <div className="flex justify-between text-sm">
            ...
            {isSentToPharmacy ? (
              <span className="font-semibold text-forest-700 flex items-center gap-1.5">
        ...
        <div className="bg-forest-50 border border-forest-100 rounded-xl p-5 text-left mb-8">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-start gap-2">
              <span className="text-forest-700 mt-0.5 font-bold">1.</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-forest-700 mt-0.5 font-bold">2.</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-forest-700 mt-0.5 font-bold">3.</span>
