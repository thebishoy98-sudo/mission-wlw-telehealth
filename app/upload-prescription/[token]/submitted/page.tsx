    ...
    <main className="min-h-screen bg-gray-50">
      <div className="mx-auto flex min-h-screen max-w-xl items-center px-4 py-10">
        <div className="w-full rounded-lg border border-gray-100 bg-white p-6 text-center shadow-sm sm:p-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Prescription received</h1>
          <p className="mt-3 text-sm leading-6 text-gray-600">
            Thanks! Our provider will review your previous prescription and approve
            your order before it&apos;s sent to the pharmacy. We&apos;ll text you
            once it&apos;s approved.
          </p>
        </div>
      </div>
