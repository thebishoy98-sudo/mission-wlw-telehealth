  ...
  return (
    <div className="space-y-5">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-7">
        ...
        {/* Selfie Video */}
        <div>
          <h3 className="font-semibold text-gray-800 mb-1">20-Second Selfie Video</h3>
          ...
          {selfieUploaded ? (
            <div className="border-2 border-green-200 bg-green-50 rounded-xl p-6 text-center">
              <CheckCircle className="w-10 h-10 text-green-500 mx-auto mb-2" />
              <p className="font-semibold text-green-700">Selfie video recorded</p>
            ...
            <div className="border-2 border-red-300 bg-red-50 rounded-xl p-6 text-center">
              <div className="flex items-center justify-center gap-2 mb-3">
                ...
                <span className="text-red-600 font-semibold">Recording... {recordingSeconds}s / 20s</span>
              </div>
            ...
            <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center space-y-4">
              ...
              <p className="text-gray-600 text-sm">Record a 20-second selfie holding your ID</p>
