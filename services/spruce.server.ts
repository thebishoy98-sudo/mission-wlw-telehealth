...
const DEFAULT_TEMPLATES: Record<string, string> = {
  ...
  subscription_cancelled: "Your Mission WLW auto-refill subscription has been cancelled — you won't be charged again. You can restart anytime from your patient portal or by placing a new order. Questions? Just reply.",
  subscription_reactivated: "Welcome back! Your Mission WLW auto-refill subscription is active again. Your next 8-week refill is scheduled for {{nextRunDate}}. Reply STOP anytime to cancel.",
  subscription_skipped: "Done — we've skipped this round of your Mission WLW auto-refill. Your next refill is now scheduled for {{nextRunDate}}. Reply STOP anytime to cancel.",
  subscription_charged_no_ship: "Hi {{patientName}}, we've charged {{amount}} to your card ending {{cardLast4}}. {{note}} Nothing new will ship — this covers medication you already received. Questions? Just reply.",
